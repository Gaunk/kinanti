                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="<?php base_url('user/edittestimonials/' . $testimonials['id']); ?>" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?= $testimonials['id'];?>">
                                        <input type="hidden" name="tanggal" value="<?= $testimonials['tanggal'];?>">
                                        <input type="hidden" name="user" value="<?= $testimonials['user'];?>">
                                            <div class="form-row">
                                                <div class="form-group col-md-5">
                                                  <label for="name">Nama</label>
                                                  <input type="text" class="form-control" name="name" id="name" value="<?= $testimonials['name'] ?>">
                                                </div>
                                            <div class="form-group col-md-5">
                                                ...
                                                <select class="form-control" name="id_pekerjaan" id="id_pekerjaan" required>
                                                    <?php foreach ($user_pekerjaan as $key): ?>
                                                        <?php if($key == $testimonials['id_pekerjaan']): ?>
                                                    <option value="<?= $key['id_pekerjaan']; ?>" selected><?= $key['pekerjaan']; ?></option>
                                                    <?php else : ?>
                                                ...
                                                <select class="form-control" name="status_perkawinan" id="status_perkawinan">
                                                    <option>-- Pilih --</option>
                                                    <?php foreach($status_perkawinan as $st ) : ?>
                                                    <?php if($st == $testimonials['status_perkawinan']): ?>
                                            ...
                                            <div class="form-group">
                                               <?php
                                                ...
                                                <textarea class="form-control" name="isi" id="isi" rows="3"><?= $testimonials['isi'] ?></textarea>
                                            </div>
                                            
                                            <div class="form-row mt-2">
                                                 <div class="col-md-6">
                                                     <img src="<?= base_url('./assets/img/testimonials/' . $testimonials['gambar']); ?>" class="img-thumbnail text-center" width="510px"><br>
                                                </div>
                                           </div>
