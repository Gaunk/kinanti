            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; LieurCoding <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
            ...
            <!-- Page Chart plugins -->
            <script src="<?= base_url('public/_temp/'); ?>vendor/chart.js/Chart.min.js"></script>

            <!-- Page level custom scripts -->
            <script src="<?= base_url('public/_temp/'); ?>js/demo/chart-area-demo.js"></script>
            <script src="<?= base_url('public/_temp/'); ?>js/demo/chart-pie-demo.js"></script>
